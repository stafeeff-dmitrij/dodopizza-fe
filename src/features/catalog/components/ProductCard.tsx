	...
	return (
		<div className={cn('flex flex-col justify-between min-w-[233px]', className)}>
			<div className='flex flex-col'>
				<img className="w-[233px] h-[233px] self-center transition-transform duration-300 hover:translate-y-1" src={image} alt={name}/>
			...
			<div className="flex justify-between items-center">
				...
				{count > 0
					...
					: <Button variant="block" disabled={true} className="px-5 py-2 text-[16px] font-normal">
						Раскупили
					</Button>
				}
			</div>
